...
5. Getting Started
 ...
 Prerequisites
* Python >= 3.8
* Required libraries: (Matplotlib,Tkinter,CustomTkinter)

6. Project Directory Structure

├── main.py                   # Application entry point (Run this file to start the GUI)
├── app_ui.py                 # GUI implementation using CustomTkinter
├── scheduler_logic.py        # Core algorithmic logic for SRTF & Priority Scheduling
├── config.py                 # Configuration settings and constant values
├── README.md                 # Project documentation and setup guide
├── scheduling_report.docx    # Detailed academic project report
